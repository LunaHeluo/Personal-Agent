...
def _redact_text(value: str) -> str:
    ...
    # Browser snapshots commonly contain single-line JavaScript/HTML.  Redact
    # quoted values first so the generic line-oriented matcher cannot erase the
    # remainder of a restricted artifact.
