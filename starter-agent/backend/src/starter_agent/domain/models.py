...
class ChatResult(BaseModel):
    ...
    # A job-research request is asynchronous once it enters the durable
    # delegation path.  These optional references preserve the Chat contract
    # without exposing Child artifacts or raw tool results.
    ...
    effective_tool_view_hash: str | None = None
