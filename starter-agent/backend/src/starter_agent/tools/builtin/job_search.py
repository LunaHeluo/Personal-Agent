...
class SearchJobsSerpApiTool(Tool):
    ...
    async def _search_variants(
        ...
        *,
        ...
        for row in raw_results:
            ...
            attribution = preferred_company_attribution(current, row)
            current["company"] = attribution.company
            current["company_source"] = attribution.source
            current["company_confidence"] = attribution.confidence
    ...
    def _parse_google_jobs(
        ...
        for position, item in enumerate(jobs):
            ...
            common = {
                ...
                "company": company,
                "company_source": "google_jobs" if company else "",
                "company_confidence": "high" if company else "",
    ...
    def _parse_google(
        ...
        for position, item in enumerate(items):
            ...
            attribution = infer_organic_company(title, snippet)
            results.append(
                {
                    "title": title,
