...
_REQUIRED_FIELDS_BY_TYPE: dict[str, tuple[str, ...]] = {
    ...
    "orchestration_scenarios": ("schema_version", "scenarios"),
    "delegation_scenarios": ("schema_version", "scenarios"),
}
